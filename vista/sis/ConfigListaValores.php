...
<html lang="es">
<head>
  <title>Configuraciones | Lista Valores</title> 
  <!-- Standard Meta -->
  <meta charset="utf-8" />
...
<body>  
  ...
  <div class="ui container"> 
    ...
    <h3 class="ui center aligned dividing header">Valores de <?php echo $Lista['nombre'] ?></h3>

    <a class="ui labeled icon button" href="ConfigLista.php">
      <i class="left arrow icon"></i>
      Volver
    </a>

    <a class="ui labeled blue icon button" href="ConfigListaValoresRegistrar.php?id=<?php echo $Lista['id_lista'] ?>">
      <i class="plus icon"></i>
      Registrar
    </a>
    ...
    <?php
      $listado=$OListaValores->listar($_GET["id"]);
