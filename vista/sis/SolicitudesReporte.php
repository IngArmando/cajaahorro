  ...
  <div class="ui container">
    <h2 class="ui center aligned small block icon inverted header">
      ...
      Reportes de Solicitudes               
        ...
        <form class="ui large form" method="POST" action="../../fpdf/PDFRepSolicitudes.php" name="formulario" id="formulario" target="_BLANK">
          <div class="ui center aligned three column grid divided form">
            <div class="column">
              <div class="ui sub header">Rango de fechas</div>
                <br>
            ...
            <div class="column">
              ...
              <div class="field">
                <label>Estatus</label>
                 <select class="ui dropdown" name="Estatus" placeholder="Todos">
                   <option></option>
