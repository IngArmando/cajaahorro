<?php
    ...
    $id = filter_input(INPUT_GET, "idprestamo",FILTER_VALIDATE_INT);
...
<body>  
    ...
    <div class="ui container">
        ...
        <form class="ui large form" method="POST" name="formulario" id="formulario" autocomplete="off" action="../../controlador/CSolicitudPersonal.php">
            <h3 class="ui center aligned header"> EXTENSIÓN DE PRESTAMO </h3> 
            <!--<p align="justify">
            ...
            <div class="ui info message">
              <i class="fitted info circle icon"></i> TEXTO DE AYUDA
            </div>
            <h4 class="ui dividing header">Datos de la Extensión</h4>
            
            <div class="three fields">

              <div class="required field">
                <label>Deuda (Monto Anterior)</label>
              ...
              <div class="required field">
                <label>Meses a Extender <i class='fitted help circle icon link' data-title="Ayuda" data-content='Las cuotas serán descontadas por nómina mensualmente.' data-variation='basic'></i></label>
                <?php
