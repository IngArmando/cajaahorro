...
<body>  
  ...
  <div class="ui container"> 
    ...
    <h3 class="ui center aligned dividing header">Registrar Compra</h3>
    ...
    <form class="ui large form" method="POST" action="../../controlador/CCompra.php" id="formulario" name="formulario">
      ...
      <div class="two fields">
        ...
        <div class="required field">
          ...
          <?php
            $tagcbotp=$combo->gen_combo("SELECT id_persona,CONCAT(nacionalidad,'-',cedula,' / ',nombre1,' ',apellido1) AS datos FROM cappiutep.t_persona WHERE estatus='1'", "id_persona","datos", isset($_GET[''])?$_GET['']:'','id_persona',' class="ui search dropdown" ');
        ...
        <div class="required field">
          ...
          <?php
            $tagcbotp=$combo->gen_combo("SELECT id_casa_comercial,descripcion FROM cappiutep.t_casa_comercial WHERE estatus='1'", "id_casa_comercial","descripcion", isset($_GET[''])?$_GET['']:'','id_casa_comercial',' class="ui search dropdown" ');
            foreach ($tagcbotp as $tagtp){echo $tagtp;}
          ?>
        </div>
      ...
      <div class="two fields">
        ...
        <div class="required field">
          ...
          <textarea id="descripcion" name="descripcion" placeholder="Ingrese aquí la descripción de la compra" ></textarea>
        </div>
