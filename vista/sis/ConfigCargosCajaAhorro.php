...
<html lang="es">
<head>
  <title>Configuraciones | Cargos de la Caja de Ahorros</title> 
  <!-- Standard Meta -->
  <meta charset="utf-8" />
...
<body>  
  ...
  <div class="ui container"> 
    ...
    <h3 class="ui center aligned dividing header">Cargos de la Caja de Ahorro</h3>
    ...
    <a class="ui labeled blue icon button" href="ConfigCargosCajaAhorroRegistrar.php">
      <i class="plus icon"></i>
      Registrar
    </a>
