...
<body>  
    ...
    <div class="ui container"> 
        ...
        <form class="ui large form" method="POST" name="formulario" id="formulario" autocomplete="off" action="../../controlador/CSolicitudEspecial.php">
            ...
            <h3 class="ui center aligned header"> Solicitud de Préstamo Hipotecario </h3> 
            <p align="justify"></p>
            <p>
            ...
            <div class="two fields">
              ...
              <div class="required field">
                ...
                <?php
                $tagcbotp=$combo->gen_combo("SELECT p.*, CONCAT (p.nombre_plazo,' - ', p.min_meses,' cuotas') as Desc FROM cappiutep.t_beneficio_plazo as p WHERE id_beneficio=6 AND estatus='1' ", "min_meses","desc", isset($_GET[''])?$_GET['']:'','Plazo',' class="ui compact dropdown"');
