...
<html lang="es">
<head>
  <title>Descuentos Generales Casas Comerciales</title> 
  <!-- Standard Meta -->
  <meta charset="utf-8" />
...
<div class="ui container">
  ...
  <div class="panel-heading">DESCUENTOS GENERALES CASAS COMERCIALES</div>
  <div class="panel-body">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><?php $tagcbotp=$combo->gen_combo2("SELECT * from cappiutep.t_tipo_persona","id_tipo_persona","nombre", isset($_GET[''])?$_GET['']:'','beneficiario',' class="ui search dropdown selection" onchange="ver_bienes(this.value)"');
                  foreach ($tagcbotp as $tagtp){echo $tagtp;}
            ?>   
            </td>
        </tr>
...
<script type="text/javascript">
  ...
  function ver_bienes(a) {
    ...
    bne= bn.value;
    if(bne == ''){
      alert('Seleccione una casa cormercial');
      bn.focus();
    }else{
      $("#muestra_tabla").load('load_tablegeneral.php?cod='+bne+'&tipo='+a+'&me='+me+'&ano='+anos);
  ...
  function ver_bienes2(a) {
    ...
    if(bne == ''){
      ...
      $("#muestra_tabla").load('load_tablegeneral.php?cod='+bne+'&me='+me+'&ano='+anos+'&tipo='+a);
