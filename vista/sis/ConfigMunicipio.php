...
session_start();
  ...
  include('../../modelo/MEstado.php');
  $OEstado = new Estado;
  $OEstado -> setIdEstado($_GET['id']);
  $registro=$OEstado -> consultar();
  while ( $fila = $OEstado->setArreglo( $registro ))
      $datos[] = $fila;
    foreach ($datos as $Estado) { $Estado; }
...
<body>  
  ...
  <div class="ui container"> 
    ...
    <h3 class="ui center aligned dividing header">Municipios del Estado <?php echo $Estado['estado'] ?></h3>

    <a class="ui labeled icon button" href="ConfigEstado.php">
    ...
    <?php
      $listado=$OMunicipio->listar($_GET["id"]);
