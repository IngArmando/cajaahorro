...
<?php include_once('Menu.php'); ?> <!-- Menu Lateral -->
   <div class="ui container"> 
      <form class="ui form" method="POST" action="../../ctrl/c_socio.php" name="f_socio">
	         <h2 class="ui center aligned small block icon inverted header">
			    <i class="announcement  icon"></i>
			    Anuncios
			 </h2>

		 <h4 class="ui center aligned header"> Modificar Anuncio </h4>               
		 <p>  Realice los cambios que desee y presione el botón "Modificar".
		 </p>
		...
		<div class="ui center aligned block inverted header">
			...
			<input type="button" class="ui primary button" value="Modificar" onclick="enviar(this.value)">
