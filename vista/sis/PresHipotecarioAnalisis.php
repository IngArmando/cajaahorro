<?php
    ...
    $tasaInteres = $OBenef->get_tasa_interes(6);

    include_once("../../modelo/MSocio.php");
    $OSocio = new Socio();
    $tipoDocente = $OSocio->getTipoDocente($_SESSION["userActivo"]);
    $condiciones = $OBenef->getCondiciones(6,$tipoDocente);
 ...
 //OBTENER REQUISITOS
    $requisitos = $OBenef->getRequisitos(6);
...
<body>  
    ...
    <div class="ui container"> 
        ...
        <form class="ui large form" method="POST" name="formulario" id="formulario" autocomplete="off" action="../../controlador/CSolicitudEspecial.php">
            ...
            <h3 class="ui center aligned header"> Solicitud de Préstamo de Reparación de Vehículo</h3> 
            ...
            <div class="three fields">     
                ...
                <div class="field">
                   ...
                   <div class="field"><!-- Nacionalidad -->
                      <?php
                            $tagcbotp=$combo->gen_combo("SELECT p.*, CONCAT (p.nombre_plazo,' - ', p.min_meses,' cuotas') as Desc FROM cappiutep.t_beneficio_plazo as p WHERE id_beneficio=6 AND estatus='1' ", "min_meses","desc", isset($datosSolicitud['cuotas'])?$datosSolicitud['cuotas']:'','Plazo',' class="ui compact dropdown"');
