...
<body>  
  ...
  <div class="ui container">
    ...
    <a class="ui labeled blue icon button" href="PagoDescuentoRegistrar.php">
      <i class="plus icon"></i>
      Registrar
    </a>

<h4 class="ui centered block dividing header"> Pagos y Descuentos </h4>
        <?php
