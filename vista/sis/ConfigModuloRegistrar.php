    ...
    <form class="ui large form" method="POST" action="../../controlador/CModulo.php" id="formulario" name="formulario">
      ...
      <div class="two fields">
        <div class="required field">
          ...
          <input type="text" id="Desc" name="Desc" placeholder="Nombre" onkeypress="return soloLetras(event)" >
        </div>
        
        <div class="required field">
          <label>Icono</label>
            <?php
              $tagcbotp=$combo->gen_combo_icon("SELECT * FROM cappiutep.t_icono WHERE estatus='1'", "id_icono","icono", isset($_GET[''])?$_GET['']:'','Icon',' class="ui search dropdown"');
      ...
      <div class="two fields">
        <div class="field">
          ...
          <?php
             $tagcbotp=$combo->gen_combo("SELECT * FROM cappiutep.t_modulo WHERE estatus='1'", "id_modulo","descripcion", isset($_GET[''])?$_GET['']:'','Padre',' class="ui search dropdown"');
             foreach ($tagcbotp as $tagtp){echo $tagtp;}
          ?>
        </div>
        ...
        <div class="field">
          ...
          <input type="number" id="Pos" name="Pos" min="1" max="10" onkeypress="return soloNumeros(event)" >
        </div>        
      </div>
