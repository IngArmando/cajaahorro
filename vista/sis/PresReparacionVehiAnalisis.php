<?php
 ...
 //OBTENER REQUISITOS
    $requisitos = $OBenef->getRequisitos(3);
            ...
            <div class="three fields">     
                ...
                <div class="field">
                   ...
                   <div class="field"><!-- Nacionalidad -->
                      <?php
                            $tagcbotp=$combo->gen_combo("SELECT p.*, CONCAT (p.nombre_plazo,' - ', p.min_meses,' cuotas') as Desc FROM cappiutep.t_beneficio_plazo as p WHERE id_beneficio=3 AND estatus='1' ", "min_meses","desc", isset($datosSolicitud['cuotas'])?$datosSolicitud['cuotas']:'','Plazo',' class="ui compact dropdown"');
