...
<div class="ui container">
  ...
  <div class="panel-heading">PAGO TOTAL DE PRESTAMOS</div>
  <div class="panel-body">
    ...
    <div class="" id="muestra_tabla">
      ...
      <table class="table table-bordered">
        <tr style="background: #EEE;"><th><center>LISTADO DE PRESTAMOS </center></th></tr>
      </table>
          ...
          while ($row=$db->getArreglo($as)) {
            ...
            echo '
              <tr>
                  ...
                  <td width="5%"><form method="post" action="vista_prestamo_lq.php"> 
...
<script type="text/javascript">
  ...
  function ver_bienes(a) {
    ...
    $("#muestra_tabla").load('load_lq.php?cod='+a+'&me='+me+'&ano='+anos);
  }
