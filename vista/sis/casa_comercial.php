...
<body>  
  ...
  <div class="ui container">
    ...
    <a class="ui labeled blue icon button" href="Casa_Comercial_Registrar.php">
      <i class="plus icon"></i>
      Registrar
    </a>

<h4 class="ui centered block dividing header"> Casas Comerciales </h4>
        <?php
