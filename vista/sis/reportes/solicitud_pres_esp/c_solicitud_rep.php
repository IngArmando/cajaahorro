...
//Telefono
	...
	$pdf->Cell(25,10,utf8_decode('Telèfono:'),'LBT',0);
	$pdf->SetFont('Arial','',12);
...
//E-mail
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(41,10,utf8_decode('E-mail:'),'LBT',0);
	$pdf->SetFont('Arial','',12);
...
//Tipo de Plazo
	$pdf->SetFont('Arial','B',11);
	$pdf->Cell(45,10,utf8_decode('Plazo:'),'LBT',0);
	$pdf->SetFont('Arial','',12);
	$pdf->Cell(60,10,utf8_decode($_POST['descripcion_plazo']),'BTR',1);
