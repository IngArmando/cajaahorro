<?php 
	session_start();
	require_once("../modelo/clst_proceso_caja_ahorro.php");
	...
	$objt_proceso_caja_ahorro=new clst_proceso_caja_ahorro;
	$laMatriz=$objt_proceso_caja_ahorro->listar();
	$lobjPdf->Cell(0,6,utf8_decode("t_proceso_caja_ahorros"),0,1,"C");//titulo del pdf
	$lobjPdf->Ln(10);
