<?php 
	session_start();
	require_once("../modelo/clst_noticia.php");
	...
	$objt_noticia=new clst_noticia;
	$laMatriz=$objt_noticia->listar();
	$lobjPdf->Cell(0,6,utf8_decode("t_noticias"),0,1,"C");//titulo del pdf
	$lobjPdf->Ln(10);
	$lobjPdf->SetFont("arial","B",10);
	$lobjPdf->Cell(25,6,utf8_decode("titulo"),1,0,"C"); 
	$lobjPdf->Cell(25,6,utf8_decode("contenido"),1,0,"C"); 
	...
	while ($laMatriz[$liI][0]!=null){
		$lobjPdf->Cell(25,6,utf8_decode($laMatriz[$liI]["titulo"]),1,0,"C");
		$lobjPdf->Cell(25,6,utf8_decode($laMatriz[$liI]["contenido"]),1,0,"C");
