<?php 
	session_start();
	require_once("../modelo/clst_operacion.php");
	...
	$objt_operacion=new clst_operacion;
	$laMatriz=$objt_operacion->listar();
	$lobjPdf->Cell(0,6,utf8_decode("t_operacions"),0,1,"C");//titulo del pdf
	$lobjPdf->Ln(10);
