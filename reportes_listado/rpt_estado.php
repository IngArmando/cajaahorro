<?php 
	session_start();
	require_once("../modelo/clst_estado.php");
	...
	$objt_estado=new clst_estado;
	$laMatriz=$objt_estado->listar();
	$lobjPdf->Cell(0,6,utf8_decode("t_estados"),0,1,"C");//titulo del pdf
	$lobjPdf->Ln(10);
	...
	while ($laMatriz[$liI][0]!=null){
		$lobjPdf->Cell(25,6,utf8_decode($laMatriz[$liI]["estado"]),1,0,"C");
