    ...
    public function guardarSolicitud($tipo){
        ...
        switch($tipo){
            case 1: //aqui vamos a guardar el prestamo especial
                $sql = "INSERT INTO cappiutep.t_beneficio_solicitud(id_solicitante,id_beneficio,fecha,monto,cuotas,interes_cuotas,monto_pago_especial) VALUES( (SELECT id_persona from  cappiutep.t_persona  where cedula = '$this->solicitante'),".$tipo.",CURRENT_DATE,'$this->monto',$this->cuotas,'$this->interes','$this->monto_especial')";
            break;
...
public function guardarExtencion($tipo,$dni){
    ...
    public function modificar_beneficios($cod_beneficio,$valorpp) {
       ...
       // echo "UPDATE cappiutep.t_beneficio SET presidente='$this->presidente', encargado='$this->encargado', sueldo_base='$this->sueldobase' , dia_corte='$this->diacorte', tasa_interes='$this->Interes' where id_beneficio = '$cod_beneficio'";
        ...
        //exit();
        return $this->ejecutar2("UPDATE cappiutep.t_beneficio SET presidente='$this->presidente', encargado='$this->encargado', sueldo_base='$this->sueldobase' , dia_corte='$this->diacorte', tasa_interes='$this->Interes',valorp='$valorpp' where id_beneficio = '$cod_beneficio'");
    ...
    public function getIdSolicitante() {
        ...
        $arreglo =  $this->getArreglo($consulta);
        return $arreglo[0];
    }
